  ...
  return (
    <div className='font-Poppins'>
      ...
      <div className="container mx-auto p-4">
        <h1 className="text-3xl font-bold mb-4">About KJ Somaiya Institute of Technology</h1>
        <p className="mb-4">
        ...
        <h2 className="text-xl text-red-800 font-bold mb-2">Our Vision</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl text-red-800 font-bold mb-2">Our Mission</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl text-red-800 font-bold mb-2">Key Features</h2>
        ...
        <h2 className="text-xl text-red-800 font-bold mb-2">Accreditations and Rankings</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl text-red-800 font-bold mb-2">Join Us</h2>
        <p className="mb-4">
      ...
      <div className='p-5 container font-Poppins'>
        Developer's
      </div>
      <Footer />
    </div>
