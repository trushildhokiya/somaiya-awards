...
const group2list =  [
    ...
    "Shri Sharda English Medium School Kopargaon",
    "Somaiya Vidya Mandir- Laxmiwadi",
    "Smt. Sakarbai Somaiya Junior College of Education (DEd)",
    "SK Somaiya Vinay Mandir High School, Mumbai",
    "Nareshwadi Learning Centre- Dahanu",
    "KJ Somaiya Private Industrial Training Institute",
    "KJ Somaiya English Medium School Sameerwadi",
...
const group3list =  [
    ...
    "Somaiya College of Research and Consultancy",
    "Somaiya Sports Academy",
...
const getCounts = asyncHandler( async(req,res)=>{
    ...
    //Group1
    countData.group1 = (await OutstandingInstitution.count(
        {
            where: {institute_name:group1list}
            
        }
    ) + await NonTeaching.count(
        {
            where: {institute_name:group1list}
            
        }
    )+await Teaching.count(
        {
            where: {institute_name:group1list}
    ...
    //Group2
    countData.group2 = (await OutstandingInstitution.count(
        {
            where: {institute_name:group2list}
    ...
    //Group3
    countData.group3 = (await OutstandingInstitution.count(
        {
            where: {'institute_name':group3list}
    ...
    console.log(countData.group3)   
    //Group4
    countData.group4 = (await OutstandingInstitution.count(
        {
            where: {institute_name:group4list}
